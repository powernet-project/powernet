...
def HomeHub(realS, pricesCurrent, LCtime, rampFlag, RstartList, QiList, RsignList, ramp_next,uboundMin,uboundMax):
    ...
    if rampFlag == 1:
    	...
    	U_ramp_test, ramp_duration, t_idx_new = GC.disaggregateRampSignal_mod(t_idx, q0, ramp_next,t_idx_old,uboundMin, uboundMax)
