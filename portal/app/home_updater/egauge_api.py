...
class EgaugeInterface():
    ...
    def __init__(self, url=None, username=None, password=None, 
        ...
        print ("url:%s, device_uid: %s" % (url, device_uid))
        ...
        self.keys = ['L1_Voltage', 'L2_Voltage', 'POWER-P', 'POWER-P*', 'POWER_SUBPANEL-P'
                     # Living Rooms
                     'FURNACE-P', 'LIGHT-P', 'LIVING_ROOM_1-P', 'LIVING_ROOM_2-P',
                     # Bedrooms
                     'BEDROOM_1-P', 'BEDROOM_2-P',
                     # Kitchen
                     'KITCHEN_A-P', 'KITCHEN_B-P', 'KITCHEN_PLUGS-P', 'MICROWAVE-P', 'OVEN-P', 'REFRIGERATOR-P', 
                     # Laundry
                     'DISHWASHER-P', 'DRYER-P', 'DRYER_A-P', 'DRYER_B-P',
                     # Others
                     'AC-P', 'EV-P', 'GARAGE-P', 'WASHER-P', 'SOLAR-P', 'SUBPANEL_A', 'SUBPANEL_B',
                     'LIGHT1-P', 'LIGHTS1-P', 'LIGHTS2-P', 'LIGHTS-P', 
                     'PLUGS_APPLIANCE1-P', 'PLUGS_APPLIANCE2-P', 'PLUGS_APPLIANCE3-P',
                     # Additional
                     'ts', 'timestamp']

    # Function to get and format e-gauge data
    def get_egauge_data(self, request):
        print('***get_egauge_data***')
    ...
    def processing_egauge_data(self):
        ...
        if HomeDevice.objects.filter(
            ...
            print('No egauge device created. Created a new one')
...
def update_egauge_data():
    ...
    print("-"*60)
    # url example: https://egauge47573.egaug.es/cgi-bin/egauge
