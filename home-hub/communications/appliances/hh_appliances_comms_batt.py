...
def relay_th():
    ...
    while(True):
        ...
        if batt_orig_status != batt_new_status:
            battTime = -1
            while(battTime == -1):
                battTime = batteryPower(status_PW2, 10, tcpClient)
